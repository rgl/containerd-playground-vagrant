...
# TODO use --restart unless-stopped when containerd supports it (should be available after containerd 1.6.7).
...
#      see https://github.com/containerd/containerd/blob/v1.6.7/runtime/restart/restart.go # but 1.6.7 does not.
