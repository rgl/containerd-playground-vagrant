...
# see https://github.com/distribution/distribution/blob/v2.8.3/docs/configuration.md
...
# TODO use --restart unless-stopped when containerd supports it (available in containerd 1.7.0+).
